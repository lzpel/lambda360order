    ...
    <div style={{ fontFamily: "'Noto Sans JP', 'Hiragino Sans', 'Meiryo', sans-serif", color: "#333", margin: 0 }}>
      ...
      <header style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <div style={{ color: accent, fontSize: 24, fontWeight: 800, letterSpacing: "-0.5px" }}>katachiform</div>
        </div>
        <nav style={{ display: "flex", gap: 28, alignItems: "center" }}>
          <a href="#features" style={{ color: "#fff", textDecoration: "none", fontSize: 14 }}>特長</a>
          <a href="#howto" style={{ color: "#fff", textDecoration: "none", fontSize: 14 }}>使い方</a>
          <a href="#examples" style={{ color: "#fff", textDecoration: "none", fontSize: 14 }}>活用事例</a>
          <a href="#pricing" style={{ color: "#fff", textDecoration: "none", fontSize: 14 }}>料金</a>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: 48, marginBottom: 12, color: navy }}>&#9654;</div>
            <div style={{ color: navy, fontSize: 16, fontWeight: 600, marginBottom: 8 }}>
              katachiform デモ画面
            </div>
            <div style={{ color: "#888" }}>
              板金制御盤ボックスの3Dフォームが動作している画面キャプチャ（GIF/動画）を挿入
            </div>
          </div>
        </div>
      </section>
