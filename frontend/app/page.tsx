			...
			<footer style={{
				...
				<div style={{
					...
					<div>
						...
						<p style={{ color: textLight, fontSize: 16, lineHeight: 1.7, margin: 0 }}>
					...
					<div style={{ display: "flex", gap: 48 }}>
						<div>
							<div style={{ color: "#fff", fontSize: 16, fontWeight: 700, marginBottom: 12 }}>プロダクト</div>
							<div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
								<a href="#features" style={{ color: textLight, fontSize: 16, textDecoration: "none" }}>特長</a>
								<a href="#howto" style={{ color: textLight, fontSize: 16, textDecoration: "none" }}>使い方</a>
								<a href="#pricing" style={{ color: textLight, fontSize: 16, textDecoration: "none" }}>料金</a>
							</div>
						</div>
						<div>
							<div style={{ color: "#fff", fontSize: 16, fontWeight: 700, marginBottom: 12 }}>リソース</div>
							<div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
								<a href="#examples" style={{ color: textLight, fontSize: 16, textDecoration: "none" }}>活用事例</a>
								<Link href="/dev" style={{ color: textLight, fontSize: 16, textDecoration: "none" }}>開発者向け</Link>
							</div>
						</div>
					</div>
				</div>
				<div style={{
					...
					<p style={{ color: textLight, fontSize: 16, margin: 0 }}>© 2026 katachiform. All rights reserved.</p>
				</div>
			</footer>
		</div>
	);
