...
export const input: InputSchema = {
    diameter: { type: "number", label: "内径", unit: "mm", value: 20, constraint: { min: 10, max: 100, step: 5 } } as NumberInput,
    length: { type: "number", label: "長さ", unit: "mm", value: 30, constraint: { min: 10, max: 200, step: 5 } } as NumberInput,
    color: {
